...
const Details = () => {
    return (
        <section className="py-16 bg-gray-100">
            ...
            <h2 className="text-3xl font-bold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">Visa Processing Support Center in Bangladesh</h2>
